...
describe 'dh_easy-core' do
  ...
  it 'should list all scripts from directory except script_a' do
    ...
    file_list = DhEasy::Core.all_scripts directory, except: [self_script]
    expected = [
      File.expand_path('./test/fake_scripts/group_a/script_b.rb'),
      File.expand_path('./test/fake_scripts/group_a/script_c.rb')
    ]
  ...
  it 'should require all scripts with except' do
    out, err = capture_io do
      DhEasy::Core.require_all 'fake_scripts/group_a', except: ['script_c']
    end
  ...
  it 'should require relative all scripts from subdirectories with except' do
    out, err = capture_io do
      DhEasy::Core.require_relative_all './test/fake_scripts/group_d/**/', except: ['script_b']
    end
  ...
  it 'should require all scripts from subdirectories with except' do
    out, err = capture_io do
      DhEasy::Core.require_all 'fake_scripts/group_c/**/', except: ['script_b']
    end
  ...
  it 'should require relative all scripts with except' do
    out, err = capture_io do
      DhEasy::Core.require_relative_all './test/fake_scripts/group_b', except: ['script_c']
    end
  ...
  it 'should expose an environment to an object' do
    ...
    object = Object.new
    DhEasy::Core.expose_to object, env
  ...
  it 'should extract an object instance methods' do
    ...
    data = DhEasy::Core.instance_methods_from object
    assert_equal expected.sort, data.sort
  end

  it 'should analyze compatibility when uncompatible fragment' do
    data = DhEasy::Core.analyze_compatibility [1,2,3,4,5], [1,2,6]
    expected = {
      missing: [6],
      new: [3,4,5],
      is_compatible: false
  ...
  it 'should analyze compatibility when compatible fragment' do
    data = DhEasy::Core.analyze_compatibility [1,2,3,4,5], [1,2,3]
    expected = {
      missing: [],
      new: [4,5],
      is_compatible: true
  ...
  it 'should analyze compatibility when equal' do
    data = DhEasy::Core.analyze_compatibility [1,2,3], [1,2,3]
    expected = {
      missing: [],
      new: [],
      is_compatible: true
  ...
  it 'should deep stringify a hash with clone' do
    ...
    data = DhEasy::Core.deep_stringify_keys hash
    expected = {
      'aaa' => {
        'bbb' => 222,
        'ccc' => 333,
  ...
  it 'should keep input hash without modification when deep stringify a hash with clone' do
    ...
    DhEasy::Core.deep_stringify_keys hash
    expected = {
      'aaa' => {
        bbb: 222,
        'ccc': 333,
  ...
  it 'should deep stringify a hash without clone' do
    ...
    data = DhEasy::Core.deep_stringify_keys hash, false
    expected = {
      'aaa' => {
        'bbb' => 222,
        'ccc' => 333,
  ...
  it 'should deep clone a hash while keep deep value references' do
    ...
    data = DhEasy::Core.deep_clone hash
    data['level1A'] = 444
  ...
  it 'should deep clone a hash while clone deep values' do
    ...
    data = DhEasy::Core.deep_clone hash, true
    data['level1A'] = 444
    data['level1B']['level2A'][:level3A].pop
    data['level1C'] = 'CCC'
    expected_input = {
